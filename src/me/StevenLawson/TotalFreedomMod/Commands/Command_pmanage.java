...
public class Command_pmanage extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole){
        ...
        if (mode.equals("add")) 
        {
        	...
        	if (player == null){
        		sender.sendMessage(TFM_Command.PLAYER_NOT_FOUND); //Says Player not found! if the player was not found
        	}
        ...
        if (mode.equals("del"))
        {
        	Player player = getPlayer(args[1]);
        	if (player == null){
        		sender.sendMessage(TFM_Command.PLAYER_NOT_FOUND); //Cannot find player
        	}
          ...
          if (mode.equals("opme"))
        {
           ...
           sender.sendMessage(TFM_Command.YOU_ARE_OP); //Sends You are op! message
